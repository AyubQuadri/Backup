...
filename="C:\\Users\\quadris\\Desktop\\My Learning\\INSOFE CPEE\\Day 22 Sentiment Analysis & summarization\\Lab Activity\\"
io.open(filename, encoding='latin-1')


os.chdir("C:\\Users\\quadris\\Desktop\\My Learning\\INSOFE CPEE\\Day 22 Sentiment Analysis & summarization\\Lab Activity\\")

##### Reading data using Pandas and preparaing data 
short_pos=pd.read_table("positive.txt",sep="\n", header=None)
short_neg=pd.read_table("negative.txt",sep="\n", header=None)
