rm(list = ls())
setwd("C:/Users/quadris/Desktop/My Learning/INSOFE CPEE/Day 27 Deep Learning/Lab Activity")

#### Read the data
data <- read.csv("germandata.csv",header = F,sep = ",")

#split the data into test and train
library(caTools)
sample = sample.split(data$V21,SplitRatio = 0.7)
train = subset(data,sample==TRUE)
test = subset(data,sample==FALSE)

### Convert the test and traint to h2o
library(h2o)
h2o.init()
train <- as.h2o(train)
test <- as.h2o(test)
